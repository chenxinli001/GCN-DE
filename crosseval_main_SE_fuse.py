...
def get_args():
    ...
    parser.add_argument("--fuse_type",type=int,default=1)
    parser.add_argument("--nlc_layer",type=list,default=[])
    parser.add_argument("--SE_type",type=int,default=2)
...
model_path += 'fuse{}_SE{}_'.format(args.fuse_type, args.SE_type)
...
if not args.test_vis:
    for k_fold in range(5):
        net = fss_fea_fuse(args.pretrain,args.fuse_type,args.SE_type,args.nlc_type,nlc_layer).cuda()
