...
python3 crosseval_main_SE_ms_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run1 --pretrain 
python3 crosseval_main_SE_ms_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run2 --pretrain  
python3 crosseval_main_SE_ms_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run3 --pretrain 

python3 crosseval_main_SE_ss_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run1 --pretrain 
python3 crosseval_main_SE_ss_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run2 --pretrain  
python3 crosseval_main_SE_ss_cons1.py --gpu $gpu --dataset MRI --organ left_kidney --run_order run3 --pretrain 
