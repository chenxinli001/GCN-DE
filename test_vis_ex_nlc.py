...
model_path = './result_correct/MRI/liver/base_pretrain_nlc4_[5, 6, 7]_run1/0-fold_best.pth'
k_fold = 0

vis_layer = [5, 6, 7]

# net = fss_feature_ex1(pretrain=True,nlc_layer=[5]).cuda()
net = fss_fea_nlc(pretrain=True,SE_type=1,nlc_type=4,nlc_layer=[5, 6, 7]).cuda()
