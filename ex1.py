...
if DataSet == 'MRI':
    ...
    num_epoch = 25
    Num_support = 8 #原始测量
    model_path = './result_ex1/CT/'


model_path = model_path + ObjectOrgan + '/ex_'
...
if nlc_layer:
    model_path += 'nlc_%s'%str(nlc_layer)
...
for k_fold in range(1):
    net = fss_feature_ex1(nlc_layer=nlc_layer).cuda() 
    ...
    for e in range(0,num_epoch+1):
        ...
        for i_batch, sampled_batch in enumerate(train_loader):
            ...
            if i_batch % print_freq==0:
                print('Epoch {:d} | Episode {:d}/{:d} | Loss {:f}'.format(e, i_batch, len(train_loader),seg_loss))
...
print(model_path)
print('DataSet:{}, ObjectOrgan:{}, Avg Best Val dice: {:.1f}'.format(DataSet,
