...
def get_args():
    ...
    # parser.add_argument("--GC_input_type",type=int,default=None)
...
if DataSet == 'MRI':
    ...
    num_epoch = 15
    Num_support = 8 
    model_path = './result_correct3/MRI/'
    #model_path = './test/MRI/'
    ...
    num_epoch = 25
    Num_support = 8
    model_path = './result_correct3/CT/'
    #model_path = './test/CT'

model_path = model_path + ObjectOrgan + '/GC3_InputS'
GC_input_type = 'S'
...
# if nlc_layer:
#     model_path += 'nlc%d(2)_%s_'%(args.nlc_type,str(nlc_layer))
...
if not args.test_vis:
    for k_fold in range(5):
        ...
        net = fss_fea_GC(args.pretrain,GC_input_type).cuda()
