    ...
    for i_batch, sampled_batch in enumerate(train_loader):
        ...
        for layer in vis_layer:
            ...
            if layer == 5:
                ...
                attention_map = net.segmentor.w5.am.cpu().numpy().squeeze() #s,s
                ...
                attention_map = net.segmentor.w6.am.cpu().numpy().squeeze() #s,s
                ...
                attention_map = net.segmentor.w7.am.cpu().numpy().squeeze() #s,s
