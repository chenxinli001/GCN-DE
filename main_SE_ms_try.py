...
for e in range(start_epoch,num_epoch+1):
    ...
    for i_batch, sampled_batch in enumerate(train_loader):
        ...
        #     _query_label = _query_label[0]
        # else:
        #     _query_label = _query_label[np.random.choice(_query_label,1)[0]]
        ...
        # if len(_query_label)==1:
        #     tri_loss = torch.abs((s_feature[4][0:train_bs]-q_feature[4][0:train_bs])).mean()
        ...
        if i_batch % print_freq==0:
            print('Epoch {:d} | Episode {:d}/{:d} | Loss {:f}'.format(e, i_batch, len(train_loader),loss,seg_loss))
