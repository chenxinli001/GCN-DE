...
for e in range(start_epoch,num_epoch+1):
    ...
    for i_batch, sampled_batch in enumerate(train_loader):
        ...
        #     #tri_loss = ln_exp_pos_distance(s_feature[4][0:train_bs],q_feature[4][0:train_bs])
        ...
        #     loss = seg_loss + lambda_t*(tri_loss1+tri_loss2)/2
        #     # tri_loss = ( ln_exp_pos_distance(s_feature[4][0:train_bs],q_feature[4][0:train_bs]) + 
        #     #     ln_exp_pos_distance(s_feature[4][train_bs:train_bs*2],q_feature[4][train_bs:train_bs*2]) +
        #     #     ln_exp_neg_distance(s_feature[4][0:train_bs],q_feature[4][train_bs:train_bs*2]) +
        #     #     ln_exp_neg_distance(s_feature[4][train_bs:train_bs*2],q_feature[4][0:train_bs]) )/4
        # if len(_query_label)==3:
        #     tri_loss1 = ( distance(s_feature[4][0:train_bs],q_feature[4][0:train_bs]) - 
        #         distance(s_feature[4][0:train_bs],q_feature[4][train_bs:train_bs*2]) -
        ...
        #     tri_loss3 = ( distance(s_feature[4][train_bs*2:train_bs*3],q_feature[4][train_bs*2:train_bs*3]) - 
        ...
        #     loss = seg_loss + lambda_t*(tri_loss1+tri_loss2+tri_loss3)/3
            # tri_loss = ( ln_exp_pos_distance(s_feature[4][0:train_bs],q_feature[4][0:train_bs]) + 
            #     ln_exp_pos_distance(s_feature[4][train_bs:train_bs*2],q_feature[4][train_bs:train_bs*2]) +
            #     ln_exp_pos_distance(s_feature[4][train_bs*2:train_bs*3],q_feature[4][train_bs*2:train_bs*3]) +
            #     ln_exp_neg_distance(s_feature[4][0:train_bs],q_feature[4][train_bs:train_bs*2]) +
            #     ln_exp_neg_distance(s_feature[4][0:train_bs],q_feature[4][train_bs*2:train_bs*3]) +
            #     ln_exp_neg_distance(s_feature[4][train_bs:train_bs*2],q_feature[4][0:train_bs]) +
            #     ln_exp_neg_distance(s_feature[4][train_bs:train_bs*2],q_feature[4][train_bs*2:train_bs*3]) +
            #     ln_exp_neg_distance(s_feature[4][train_bs*2:train_bs*3],q_feature[4][0:train_bs]) +
            #     ln_exp_neg_distance(s_feature[4][train_bs*2:train_bs*3],q_feature[4][train_bs:train_bs*2]) )/9
        ...
        #     print('Epoch {:d} | Episode {:d}/{:d} | Loss {:f}={:f}+{:f}x{:f}'.format(e, i_batch, len(train_loader), loss,seg_loss,lambda_t,tri_loss))
        # if i_batch % print_freq==0:
        ...
        # if i_batch % print_freq==0:
        #     print('Epoch {:d} | Episode {:d}/{:d} | Loss {:f}={:f}+{:f}*{:f}'.format(e, i_batch, len(train_loader), loss,seg_loss,lambda_t,tri_loss))
        ...
        if len(_query_label)==3:
            tri_loss12 = ( torch.abs((s_feature[4][0:train_bs]-q_feature[4][0:train_bs])).mean() - 
                (torch.abs(s_feature[4][0:train_bs]-q_feature[4][train_bs:train_bs*2])).mean() )
            tri_loss13 = ( torch.abs((s_feature[4][0:train_bs]-q_feature[4][0:train_bs])).mean() - 
                (torch.abs(s_feature[4][0:train_bs]-q_feature[4][train_bs*2:train_bs*3])).mean() )

            tri_loss21 = ( torch.abs((s_feature[4][train_bs:train_bs*2]-q_feature[4][train_bs:train_bs*2])).mean() - 
                (torch.abs(s_feature[4][train_bs:train_bs*2]-q_feature[4][0:train_bs])).mean() )
            tri_loss23 = ( torch.abs((s_feature[4][train_bs:train_bs*2]-q_feature[4][train_bs:train_bs*2])).mean() -
                (torch.abs(s_feature[4][train_bs:train_bs*2]-q_feature[4][train_bs*2:train_bs*3])).mean() )
            
            tri_loss31 = ( torch.abs((s_feature[4][train_bs*2:train_bs*3]-q_feature[4][train_bs*2:train_bs*3])).mean() - 
                (torch.abs(s_feature[4][train_bs*2:train_bs*3]-q_feature[4][0:train_bs])).mean() )
            tri_loss32 = ( torch.abs((s_feature[4][train_bs*2:train_bs*3]-q_feature[4][train_bs*2:train_bs*3])).mean() -
